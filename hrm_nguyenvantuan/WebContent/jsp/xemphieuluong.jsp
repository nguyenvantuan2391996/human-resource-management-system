	...
	<div class="container-fluid main-container">
				...
				<div class="side-menu">
					...
					<div class="side-menu-container">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="xemphieuluong"><span
		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
				<div class="panel-heading">Xem phiếu lương</div>
												...
												<tr>
													...
													<td><p data-placement="top" data-toggle="tooltip"
															...
															<button class="btn btn-primary btn-xs"
																...
																data-target="#delete${arrtl.manv }">
																<span class="glyphicon glyphicon-ok"></span>
															</button>
														</p></td>
												</tr>
												<!--Dialog delete-->
												<form method="post" action="xemphieuluong">
													<div class="modal fade" id="delete${arrtl.manv }"
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="form-group">
																		<input type="hidden" name="type" value="xacnhanphieuluong">

																	</div>
																	<div class="form-group">
																		<input type="hidden" name="id" value=${arrtl.manv }>
