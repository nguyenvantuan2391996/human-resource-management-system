	...
	<div class="container-fluid main-container">
				...
				<div class="side-menu">
					...
					<div class="side-menu-container">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="baocaonv"><span
		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
				<div class="panel-heading">Báo cáo hàng ngày</div>
									...
									<table id="mytable" class="table table-bordred table-striped">
										...
										<tbody>
											...
											<c:forEach items="${arrbc }" var="arrbc">
												<tr>
													...
													<td><p data-placement="top" data-toggle="tooltip"
															...
															<button class="btn btn-primary btn-xs" data-title="Edit"
																data-toggle="modal" data-target="#edit${arrbc.id }">
												...
												<!--Dialog add-->
												<form method="post" action="baocaonv">
																...
																<div class="modal-body">
																	<div class="form-group">
																		<textarea rows="2" class="form-control"
																			placeholder="Nội dung báo cáo" name="ndbcadd" required></textarea>

																	</div>

																	<div class="form-group">
																		<input class="form-control " type="date" name="ngaybcadd" required>
																	</div>
																	<div class="form-group">
												...
												<!--Dialog edit-->
												<form method="post" action="baocaonv">
													<div class="modal fade" id="edit${arrbc.id }" tabindex="-1"
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	<div class="modal-body">
																		...
																		<div class="form-group">
																			<textarea rows="2" class="form-control"
																				placeholder="Nội dung báo cáo" name="ndbcedit"
																				required>${arrbc.ndbc }</textarea>

																		</div>
																		<div class="form-group">
																			<input class="form-control " type="date"
																				name="ngaybcedit" value=${arrbc.ngaybc } required>
																		</div>
																		<div class="form-group">
																		...
																		<div class="form-group">
																			<input type="hidden" name="mabc" value=${arrbc.id }>
