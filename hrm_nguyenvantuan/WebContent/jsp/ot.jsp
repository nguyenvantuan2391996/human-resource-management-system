	...
	<div class="container-fluid main-container">
				...
				<div class="side-menu">
					...
					<div class="side-menu-container">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="qlot"><span
		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
				<div class="panel-heading">Quản lý OT</div>
							...
							<div class="col-md-12">
								<div class="table-responsive">
									...
									<table id="mytable" class="table table-bordred table-striped">
										...
										<tbody>
											<c:forEach items="${arrot }" var="arrot">
												...
												<!--Dialog accept-->
												<form method="post" action="qlot">
													<div class="modal fade" id="accept${arrot.id }"
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-body">
																	...
																	<div class="form-group">
																		<input type="hidden" name="id" value=${arrot.id }>
												...
												<!--Dialog no accept-->
												<form method="post" action="qlot">
													<div class="modal fade" id="noaccept${arrot.id }"
														tabindex="-1" role="dialog" aria-labelledby="edit"
														aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
									...
									<ul class="pagination pull-right">
										<li class="disabled"><a href="qlot"><span
