	...
	<div class="container-fluid main-container">
							...
							<li class="panel panel-default" id="dropdown"><a
								...
								<div id="dropdown-lvl1">
									<div class="panel-body">
										<ul class="nav navbar-nav">
											<li class="active"><a href="qltruongphong">Quản lý
													trưởng phòng</a></li>
		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
				<div class="panel-heading">Quản lý trưởng phòng</div>
									...
									<table id="mytable" class="table table-bordred table-striped">
										...
										<tbody>
											<c:forEach items="${arrtp }" var="arrtp">
												<tr>
													...
													<td><p data-placement="top" data-toggle="tooltip"
															...
															<button class="btn btn-primary btn-xs" data-title="Edit"
																data-toggle="modal" data-target="#edit${arrtp.matp }">
													...
													<td><p data-placement="top" data-toggle="tooltip"
															...
															<button class="btn btn-danger btn-xs" data-title="Delete"
																data-toggle="modal" data-target="#delete${arrtp.matp }">
																<span class="glyphicon glyphicon-trash"></span>
															</button>
														</p></td>
												</tr>
												<!--Dialog add-->
												<form method="post" action="truongphong">
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	...
																	<div class="form-group">
																		...
																		<input class="form-control " type="text"
																			placeholder="Năm Sinh" name="namsinhadd" required>
																	</div>
																	<div class="form-group">
												...
												<!--Dialog edit-->
												<form method="post" action="truongphong">
													<div class="modal fade" id="edit${arrtp.matp }"
															...
															<div class="modal-content">
																<div class="modal-header">
																	...
																	<h4 class="modal-title custom_align" id="Heading">Chỉnh
																		sửa thông tin nhân sự</h4>
																</div>
																<div class="modal-body">
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Họ & Tên" value="${arrtp.hoten }"
																			name="hotenedit" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Năm Sinh" value="${arrtp.namsinh }"
																			name="namsinhedit" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Địa Chỉ" value="${arrtp.diachi }"
																			name="diachiedit" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Giới Tính" value="${arrtp.gioitinh }"
																			name="gioitinhedit" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Số Điện Thoại" value="${arrtp.sdt }"
																		...
																		<select required class="form-control" name="phongban">
																			...
																			<c:forEach items="${arrpb }" var="arrpb">
																				<option value="${arrpb.mapb }"
																					<c:if test="${arrpb.mapb eq arrtp.mapb }" >
																	...
																	<div class="form-group">
																		<input type="hidden" name="id" value=${arrtp.matp }>
												...
												<!--Dialog delete-->
												<form method="post" action="truongphong">
													<div class="modal fade" id="delete${arrtp.matp }"
														tabindex="-1" role="dialog" aria-labelledby="edit"
														aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
