            ...
            <nav class="navbar navbar-default" role="navigation">
              ...
              <div class="side-menu-container">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="dangkyot.html"><span class="glyphicon glyphicon-time"></span> Đăng ký OT </a></li>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title custom_align" id="Heading">Đăng ký OT</h4>
                    </div>
                    <div class="modal-body">
                      
                      <div class="form-group">

                        <input class="form-control " type="number" placeholder="Số giờ" required>
                      </div>

                      <div class="form-group">

                        <input class="form-control " type="date" placeholder="Ngày đăng ký OT" required>
                      </div>
