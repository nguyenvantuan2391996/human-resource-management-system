						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="table-responsive">
										...
										<tbody>
											<c:forEach items="${arruv }" var="arruv">
												<tr>
													...
													<td>${arruv.quantri }</td>
													<td>${arruv.phantich }</td>
													<td>${arruv.ngoaingu }</td>
													<td>${arruv.tinhoc }</td>
													<td>${arruv.cntt }</td>
												</tr>
											</c:forEach>
									...
									<!--Button-->
									<form action="xemtuvan" method="post">
										<ul class="pagination pull-right">
											<li><input type="submit" value="Xem Tư Vấn"
									...
									<ul class="pagination pull-right">
										...
										<c:forEach items="${listPage }" var="listPage">
											<li <c:if test="${page eq listPage  }">class="active"</c:if>><a
												href="xemtuvan?page=${listPage }">${listPage }</a></li>
										</c:forEach>
										<li><a href="#"><span
