										...
										<div id="dropdown-lvl1">
											<div class="panel-body">
												<ul class="nav navbar-nav">
													...
													<li class="active"><a href="xemtuvan.html">Xem tư vấn</a></li>
												</ul>
											</div>
										</div>
									</li>
									...
									<div class="col-md-12">
										<div class="table-responsive">
											...
											<table id="mytable" class="table table-bordred table-striped">
												...
												<!--Form lấy trọng số-->
												<form method="get" action="ketquatuvan.html">
													<tr>
														<td></td>
														<td>Trọng Số</td>
														<td><input class="form-control " type="number" min="0.1" max="1" step="0.01" required></td>
														<td><input class="form-control " type="number" min="0.1" max="1" step="0.01" required></td>
														<td><input class="form-control " type="number" min="0.1" max="1" step="0.01" required></td>
														<td><input class="form-control " type="number" min="0.1" max="1" step="0.01" required></td>
														<td><input class="form-control " type="number" min="0.1" max="1" step="0.01" required></td>
											...
											<ul class="pagination pull-right">
												<li><input type="submit" value="Xem Tư Vấn" class="btn btn-primary"></li>
											</ul>
										</form>
