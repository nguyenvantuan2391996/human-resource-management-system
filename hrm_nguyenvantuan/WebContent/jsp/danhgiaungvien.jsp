	...
	<div class="container-fluid main-container">
							...
							<li class="panel panel-default" id="dropdown"><a
								...
								<div id="dropdown-lvl1">
									<div class="panel-body">
										<ul class="nav navbar-nav">
											<li class="active"><a href="danhgiaungvien">Đánh giá
													ứng viên</a></li>
		...
		<div class="col-md-10 content">
			<div class="panel panel-default">
				<div class="panel-heading">Đánh giá ứng viên</div>
								...
								<div class="table-responsive">
									...
									<table id="mytable" class="table table-bordred table-striped">
										...
										<tbody>
											...
											<c:forEach items="${arruv }" var="arruv">
												<tr>
													<td>${arruv.mauv }</td>
													<td>${arruv.hoten }</td>
													<td>${arruv.hoadong }</td>
													<td>${arruv.trungthuc }</td>
													<td>${arruv.xulytt }</td>
													<td>${arruv.giaotiep }</td>
													<td><p data-placement="top" data-toggle="tooltip"
															title="Edit">
															<button class="btn btn-primary btn-xs" data-title="Edit"
																data-toggle="modal" data-target="#edit${arruv.mauv }">
												...
												<!--Dialog edit-->
												<form method="post" action="danhgiaungvien">
													<div class="modal fade" id="edit${arruv.mauv }"
																...
																<div class="modal-body">
																	<div class="form-group">
																		...
																		<input class="form-control " type="number" min="1"
																			max="10" step="0.01" value="${arruv.hoadong }" name="hoadong" placeholder="Hòa Đồng" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="number" min="1"
																			max="10" step="0.01" value="${arruv.trungthuc }" name="trungthuc" placeholder="Trung Thực"
																			required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="number" min="1"
																			max="10" step="0.01" value="${arruv.xulytt }" name="xulytt" placeholder="Xử Lý Thông Tin"
																			required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="number" min="1"
																			max="10" step="0.01" value="${arruv.giaotiep }" name="giaotiep" placeholder="Giao Tiếp" required>
																	</div>
																	...
																	<div class="form-group">
																		<input type="hidden" name="id" value=${arruv.mauv }>
									...
									<ul class="pagination pull-right">
										...
										<c:forEach items="${listPage }" var="listPage">
											<li <c:if test="${page eq listPage  }">class="active"</c:if>><a
												href="danhgiaungvien?page=${listPage }">${listPage }</a></li>
										</c:forEach>
										<li><a href="#"><span
