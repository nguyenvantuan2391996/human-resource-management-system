            ...
            <nav class="navbar navbar-default" role="navigation">
              ...
              <div class="side-menu-container">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="dangkynghiphep.html"><span class="glyphicon glyphicon-signal"></span> Đăng ký nghỉ phép </a></li>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title custom_align" id="Heading">Đăng ký nghỉ phép</h4>
                      </div>
                      <div class="modal-body">

                        <div class="form-group">

                          <select required class="form-control" id="loainghiphep">
                            <option value="">Vui lòng lựa chọn loại nghỉ phép</option>
                            <option>Sáng</option>
                            <option>Chiều</option>
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control " type="date" placeholder="Ngày đăng ký đăng ký nghỉ phép" required>
                        </div>

                        <div class="form-group">

                          <input class="form-control " type="text" placeholder="Lý do" required>
                        </div>
                      </div>
