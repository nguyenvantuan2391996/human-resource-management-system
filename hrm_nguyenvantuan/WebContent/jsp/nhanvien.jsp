                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            ...
                            <div class="side-menu-container">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href="nhanvien.html"><span class="glyphicon glyphicon-user"></span> Quản lý nhân viên </a></li>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title custom_align" id="Heading">Đánh giá nhân viên</h4>
                        </div>
                        <div class="modal-body">
                          <div class="form-group">

                            <select required required class="form-control" id="danhgia">
