				...
				<div class="side-menu">
					...
					<div class="side-menu-container">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="nhanvien"><span
									...
									<table id="mytable" class="table table-bordred table-striped">
										...
										<tbody>
											<c:forEach items="${arrnv }" var="arrnv">
												...
												<!--Dialog edit-->
												<form method="post" action="nhanvien">
																...
																<div class="modal-body">
																	<div class="form-group">
																		...
																		<select required required class="form-control"
																			name="danhgia">
																			<option value="">Vui lòng lựa chọn đánh giá</option>
																			...
																			<option value="Loại E">Loại E</option>
																		</select>
																	</div>
																	
																	<div class="form-group">

																		<select required class="form-control" name="duan">
																			<option value="">Vui lòng lựa chọn dự án</option>
																			<c:forEach items="${arrduan }" var="arrduan">
																				<option value="${arrduan.maduan }"
																					<c:if test="${arrduan.maduan eq arrnv.maduan }" >
																						selected="<c:out value="selected"></c:out>"
																					</c:if>>${arrduan.tenduan }
																				</option>
																			</c:forEach>
																		</select>
																	</div>
																	...
																	<div class="form-group">
																		<input type="hidden" name="type" value="tpedit">
