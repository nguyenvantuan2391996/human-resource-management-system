				...
				<div class="side-menu">
					...
					<div class="side-menu-container">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="qltienluong"><span
								...
								<div class="table-responsive">
									...
									<table id="mytable" class="table table-bordred table-striped">
										...
										<tbody>
											...
											<c:forEach items="${arrtl }" var="arrtl">
												<tr>
													<td>${arrtl.manv }</td>
													<td>${arrtl.hoten }</td>
													<td>${arrtl.trinhdo }</td>
													<td>${arrtl.hesoluong }</td>
													<td>${arrtl.sogiocong }</td>
													<td>${arrtl.sogioot }</td>
													<td>${arrtl.songaynghi }</td>
													<td>${arrtl.tongluong }</td>
									...
									<!--Button Tính Lương -->
									<form method="post" action="qltienluong">
										<ul class="pagination pull-right">
											<li><input type="submit" value="Tính Lương"
												class="btn btn-primary" name="tinhluong"></li>
											<li><input type="hidden" name="type" value="tinhluong"></li>
										</ul>
									</form>
									...
									<form method="post" action="qltienluong">
										<ul class="pagination pull-right">
											<li><input type="submit" value="Xuất Báo Cáo"
												class="btn btn-primary" name="xuatbc"></li>
											<li><input type="hidden" name="type" value="xuatbc"></li>
										</ul>
									</form>
									...
									<ul class="pagination pull-right">
										...
										<c:forEach items="${listPage }" var="listPage">
											<li <c:if test="${page eq listPage  }">class="active"</c:if>><a
												href="qltienluong?page=${listPage }">${listPage }</a></li>
										</c:forEach>
										<li><a href="#"><span
