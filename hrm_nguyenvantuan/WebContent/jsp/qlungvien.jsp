								...
								<div id="dropdown-lvl1">
									<div class="panel-body">
										<ul class="nav navbar-nav">
											...
											<li><a href="qlnhanvien">Quản lý nhân
													viên</a></li>
											<li class="active"><a href="qlungvien">Quản lý ứng viên</a></li>
										</ul>
									</div>
								</div></li>
									...
									<table id="mytable" class="table table-bordred table-striped">
										...
										<tbody>
											<c:forEach items="${arruv }" var="arruv">
												<tr>
													...
													<td><p data-placement="top" data-toggle="tooltip"
															...
															<button class="btn btn-danger btn-xs" data-title="Delete"
																data-toggle="modal" data-target="#delete${arruv.mauv }">
																<span class="glyphicon glyphicon-trash"></span>
															</button>
														</p></td>
												</tr>
												<!--Dialog add-->
												<form method="post" action="qlungvien">
															...
															<div class="modal-content">
																<div class="modal-header">
																	...
																	<h4 class="modal-title custom_align" id="Heading">Chỉnh
																		sửa thông tin ứng viên</h4>
																</div>
																<div class="modal-body">
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Họ & Tên" value="${arruv.hoten }"
																	...
																	<div class="form-group">
																		...
																		<input class="form-control " type="number" min="1900"
																			max="2099" step="1" placeholder="Năm Sinh"
																			value="${arruv.namsinh }" name="namsinhedit" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Địa Chỉ" value="${arruv.diachi }"
																			name="diachiedit" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Giới Tính" value="${arruv.gioitinh }"
																			name="gioitinhedit" required>
																	</div>
																	<div class="form-group">

																		<input class="form-control " type="text"
																			placeholder="Số Điện Thoại" value="${arruv.sdt }"
												...
												<!--Dialog delete-->
												<form method="post" action="qlungvien">
													<div class="modal fade" id="delete${arruv.mauv }"
														tabindex="-1" role="dialog" aria-labelledby="edit"
														aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
									...
									<ul class="pagination pull-right">
										...
										<c:forEach items="${listPage }" var="listPage">
											<li <c:if test="${page eq listPage  }">class="active"</c:if>><a
												href="qlungvien?page=${listPage }">${listPage }</a></li>
										</c:forEach>
										<li><a href="#"><span
